...
/**
 * Provides routines to access the <tt>Fatworm</tt> configuration.
 * 
 * @author xrchen
 */
public final class Config {
	...
	/**
	 * Get the value of a key, returning the specified default if the key does
	 * not exist.
	 * 
	 * @param key
	 *            the key to look up.
	...
	/**
	 * Get the value of an integer key, returning the specified default if the
	 * key does not exist.
	 * 
	 * @param key
	 *            the key to look up.
	...
	/**
	 * Get the value of a double key, returning the specified default if the key
	 * does not exist.
	 * 
	 * @param key
	 *            the key to look up.
	...
	/**
	 * Get the value of a boolean key.
	 * 
	 * @param key
	 *            the key to look up.
	 * @return the value of the specified key.
	...
	/**
	 * Get the value of a boolean key, returning the specified default if the
	 * key does not exist.
	 * 
	 * @param key
	 *            the key to look up.
